...
const CategoryDetails = () => {
    ...
    <div className="px-6 py-4">
       ...
       <p className="  text-gray-800 dark:text-white">ReSale $: 452</p>

<p className="py-2 text-gray-700 dark:text-gray-400">Original Price : $545</p>
       </div>
       <p>Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.
       </p>

     <div className='flex justify-between items-center mt-2'>
     <p className='font-bold'>Used 3 Months</p>
     <p className='font-bold'>Purchase Date: 2002</p>
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">Seller Name</h1>
        </div>
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">Dhaka</h1>
        </div>

        <div className="flex justify-between items-center mt-4 text-gray-700 dark:text-gray-200">
            

            <h1 className="px-2 text-sm font-semibold">Conditions : <span className='text-green-500'>Good</span></h1>
            <h className='font-semibold text-sm'>Phone: 01945161312</h>
        </div>
